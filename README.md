...
- **`dolly extract`**: infer a pattern from a real project, deterministically and without annotations; anything the evidence can't support becomes a note you can read rather than a facet you'd have to unlearn
